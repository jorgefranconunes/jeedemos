...
case class ScalableLabelDetails(
    size: Dimension,
    font: Font,
    textBoxSize: Dimension)


object ScalableLabel {


    def create(): ScalableLabel = new ScalableLabel()
}
 ...
 * 
 */
final class ScalableLabel private () {


    private val labelComponent: ScalableLabelComponent = new ScalableLabelComponent
     ...
     * 
     */
    def details: ScalableLabelDetails = labelComponent.details


    private final class ScalableLabelComponent
            extends JLabel {
         ...
         * 
         */
        def details: ScalableLabelDetails = ScalableLabelDetails(
            size = getSize,
